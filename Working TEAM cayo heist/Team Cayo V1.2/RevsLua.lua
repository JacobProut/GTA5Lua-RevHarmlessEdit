...
CasinoH = HeistTab:add_tab("*Diamond Casino Heist*")
...
NightclubTPTab = TeleportTab:add_tab("*Nightclub Teleports*")

    NightclubTPTab:add_button("TP to Bar", function()
        PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), -1578.68, -3013.51, -79.01)
    end)
  
    NightclubTPTab:add_button("TP to Docking Bay", function()
        PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), -1630.29, -3002.44, -78.14)
    end)  

    NightclubTPTab:add_button("TP to Safe", function()
        PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), -1617.97, -3015.61, -75.21)
    end)  

    NightclubTPTab:add_button("TP to Bathroom", function()
        PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), -1611.66, -3013.75, -79.01)
    end) 
...
--[Start of Heist Tab]--
--[Start of Cayo Heist]--
-- Cayo Heist Section was Taken from @Alestarov --
...
CayoH:add_text("---[Set Ups]---")

CayoH:add_button("SOLO Pink Diamond", function()
    PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
CayoH:add_button("DUO Pink Diamond", function()
    PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
CayoH:add_button("TEAM Pink Diamond", function()
    PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
        ...
        STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_CASH_I"), 0, true)
		STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_WEED_I"), 0, true)
        STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_COKE_I"), -1, true) -- Set all Coke Outside Compound
        STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_GOLD_I"), 0, true) -- Set all gold
		...
		STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_WEED_I_SCOPED"), 0, true)
        STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_WEED_C_SCOPED"), 0, true)
        STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_COKE_I_SCOPED"), -1, true) -- Set all Coke scoped Outside Compound
        STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_COKE_C_SCOPED"), 0, true)
        STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_GOLD_I_SCOPED"), 0, true) -- Set all gold scoped
        STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_GOLD_C_SCOPED"), 0, true) -- Set all gold scoped(COMPOUND?)
		STATS.STAT_SET_INT(joaat(mpx .. "H4LOOT_PAINT_SCOPED"), 0, true)  -- paintings scoped
...
CayoH:add_button("SOLO Panther[Rare Heist]", function()
    PlayerIndex = globals.get_int(1574918)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
CayoH:add_button("Delete Mission NPC's", function() -- Thanks to RazorGamerX for the help on this
...
CayoH:add_text("TEAM ONLY:")
CayoH:add_button("TP to Hanger", function()
            PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), 4440.97, -4459.36, 4.33)
        end)

CayoH:add_button("TP to Bottom loot", function()
            PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), 4437.81, -4449.03, 4.33)
        end)

CayoH:add_button("TP to Top loot", function()
            PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), 4445, -4444.21, 7.24)
        end)

CayoH:add_separator()
CayoH:add_text("SOLO/TEAM:")
CayoH:add_text("Go to and swim through Drainage System")
CayoH:add_button("TP to the Drainage Entrance", function()
...
local casinoCut1 = CasinoH:add_input_int("Cut 1")
local casinoCut2 = CasinoH:add_input_int("Cut 2")
local casinoCut3 = CasinoH:add_input_int("Cut 3")
local casinoCut4 = CasinoH:add_input_int("Cut 4")

CasinoH:add_button("Set",
function ()
    globals.set_int(DCCg1, casinoCut1:get_value())
	globals.set_int(DCCg2, casinoCut2:get_value())
	globals.set_int(DCCg3, casinoCut3:get_value())
	globals.set_int(DCCg4, casinoCut4:get_value())
end)

CasinoH:add_separator()
CasinoH:add_text("Teleport Section")
CasinoH:add_button("TP to Casino", function()
            PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), 969.44, -4.17, 80.52)
        end)

CasinoH:add_button("TP to outside Agatha Office", function()
            PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), 2490.33, -239.04, -55.12)
        end)

CasinoH:add_button("TP to vault before hallway", function()
            PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), 2466.75, -278.38, -70.69)
        end)

CasinoH:add_button("TP to Elevator to get upstairs", function()
            PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), 2525.36, -279.21, -70.64)
        end)

CasinoH:add_button("TP to door to outside", function()
            PED.SET_PED_COORDS_KEEP_VEHICLE(PLAYER.PLAYER_PED_ID(), 2547.96, -275.43, -58.72)
        end)

--[End of Diamond Heist]--
